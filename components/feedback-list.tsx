            ...
            {posts.map((post) => {
                ...
                return (
                    <Card key={post.id} className="hover:shadow-md transition-shadow border">
                        <CardHeader>
                            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                                <div className="flex-1 min-w-0">
                                    ...
                                    <CardDescription className="flex flex-wrap items-center gap-1.5 mt-1 text-xs sm:text-sm">
                        ...
                        <CardContent>
                            <p className="text-sm sm:text-base text-muted-foreground mb-3">{post.description}</p>
